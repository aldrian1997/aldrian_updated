...
const caseStudies = {
    'origin': {
        ...
        results: [
            'Helped improve the client onboarding flow and intake process.',
    ...
    'ipoppet': {
        ...
        results: [
            ...
            'Improved customer support access through live chat setup.',
    ...
    'artic': {
        ...
        results: [
            'Supported faster page experience through speed checks and cleanup.',
            'Helped improve SEO structure and technical site health.',
...
const iconDesktop = themeBtnDesktop ? themeBtnDesktop.querySelector('i') : null;
const iconMobile = themeBtnMobile ? themeBtnMobile.querySelector('i') : null;
const textMobile = themeBtnMobile ? themeBtnMobile.querySelector('span') : null;
